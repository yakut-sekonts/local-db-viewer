...
execFileSync(javac, ['--release', '21', '-encoding', 'UTF-8', '-cp', jars.join(delimiter), '-d', classes, 'jdbc/LocalDBViewerBridge.java', 'jdbc/JdbcMetadata.java', 'jdbc/LocalDBViewerSocketFactory.java', 'jdbc/JdbcCertificates.java'], { stdio: 'inherit' });
